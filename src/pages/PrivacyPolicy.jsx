      ...
      <main id="content" role="main">
        <div class="container content-space-2 content-space-lg-3">
          <div class="card card-lg">
            <div class="card-header bg-secondary py-sm-10">
              <h1 class="card-title h2 text-white">Privacy &amp; Policy</h1>
              <p class="card-text text-white">Last modified: July 27, 2022</p>
            </div>
            ...
            <div class="card-body">
              <div class="mb-7">
                ...
                <p>
                  ...
                  Services are provided by Pixeel Ltd. ("Space"), located at 153
                  Williamson Plaza, Maggieberg, MT 09514, England, United
                  Kingdom.
                </p>
              ...
              <div class="mb-7">
                ...
                <p>
                  Space's privacy policies explain how we treat your personal
                  data and protect your privacy when you use our Services. By
                  using our Services, you agree that Space can use such data in
                ...
                <p>
                  ...
                  information about submitting notices and Space's policy about
                  responding to notices in our Help Center.
                </p>
              </div>
              ...
              <div class="mb-7">
                ...
                <p>
                  ...
                  through our Services, you give Space (and those we work with)
                  ...
                  listing you have added to Space Maps). Some Services may offer
