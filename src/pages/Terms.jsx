        ...
        >
          <div class="container content-space-t-3 content-space-t-lg-3 content-space-b-2">
            <div class="w-md-75 w-lg-50 text-center mx-md-auto">
              <h1>Channels Realty Terms &amp; Conditions</h1>
              <p>Effective date: 1 October 2022</p>
            </div>
          </div>
        </div>
              ...
              <div class="navbar-expand-md">
                ...
                >
                  ...
                  >
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="#linksToOtherWebsInfo">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="#goveringLawInfo">
                        4. Governing law
                      </a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="col-md-8 col-lg-9">
              ...
              <div id="linksToOtherWebsInfo" class="mb-7">
                ...
                <p>
                  ...
                  services that are not owned or controlled by Space.
                </p>

                <p>
                  Space has no control over, and assumes no responsibility for,
                  the content, privacy policies, or practices of any third party
                  web sites or services. You further acknowledge and agree that
                  Space shall not be responsible or liable, directly or
              ...
              <div id="goveringLawInfo" class="mb-7">
                ...
                <p>
                  ...
                  the laws of Jersey, without regard to its conflict of law
                  provisions.
                </p>
